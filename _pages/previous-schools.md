---
permalink: /previous-schools/
title: "Previous Winter Schools"
author_profile: true
image_width: "30%"
---
...
### [2024: Graphs and Applications](https://www.sintef.no/projectweb/geilowinterschool/2024-winter-school/)
...
### [2023: Computational Statistics](https://www.sintef.no/projectweb/geilowinterschool/2023-23rd-geilo-winter-school/)
...
### [2022: Continuous Optimization](https://www.sintef.no/projectweb/geilowinterschool/2022-22nd-geilo-winter-school/)
...
### [2021: Explainable Algorithms](https://www.sintef.no/projectweb/geilowinterschool/2021/)
...
### [2020: Modern Techniques and Algorithms in High-Performance Computing](https://www.sintef.no/projectweb/geilowinterschool/2020/)
...
### [2019: Learning from Data](https://www.sintef.no/projectweb/geilowinterschool/learning-from-data/)
...
### [2018: Practical artificial intelligence](https://www.sintef.no/projectweb/geilowinterschool/2018-artificial-intelligence/)
...
### [2017: Machine Learning, Deep Learning, and Data Analytics](https://www.sintef.no/projectweb/geilowinterschool/2017-machine-learning/)

<img src="{{ site.baseurl }}/images/schools/2017.webp" style="float: right; width: 35%; margin-left: 20px;">
...
### [2016: Scientific Visualization](https://www.sintef.no/projectweb/geilowinterschool/2016-scientific-visualization/)

<img src="{{ site.baseurl }}/images/schools/2016.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2015: Uncertainty Quantification for Physical Phenomena](https://www.sintef.no/projectweb/evita/2015/)

<img src="{{ site.baseurl }}/images/schools/2015.jpg" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2014: Big Data Challenges to Modern Statistics](https://www.sintef.no/projectweb/evita/2014/)

<img src="{{ site.baseurl }}/images/schools/2014.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2013: Reproducible Science And Modern Scientific Software](https://www.sintef.no/projectweb/evita/2013/)

<img src="{{ site.baseurl }}/images/schools/2013.webp" style="float: right; width: 35%; margin-left: 20px;">
...
### [2012: Introduction to Continuum Mechanics](https://www.sintef.no/projectweb/evita/2012/)

<img src="{{ site.baseurl }}/images/schools/2012.jpg" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2011: Mathematical and numerical methods for multiscale problems](https://www.sintef.no/projectweb/evita/2011/)

<img src="{{ site.baseurl }}/images/schools/2011.webp" style="float: right; width: 35%; margin-left: 20px;">
...
### [2010: Automatic Differentiation](https://www.sintef.no/projectweb/evita/2010/)

<img src="{{ site.baseurl }}/images/schools/2010.webp" style="float: right; width: 35%; margin-left: 20px;">
...
### [2009: Optimization](https://www.sintef.no/projectweb/evita/2009/)

<img src="{{ site.baseurl }}/images/schools/2009.webp" style="float: right; width: 35%; margin-left: 20px;">
...
### [2008: Parallel Computing](https://www.sintef.no/projectweb/evita/2008/)

<img src="{{ site.baseurl }}/images/schools/2008.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2007: Monte Carlo Methods](https://www.sintef.no/projectweb/evita/2007/)

<img src="{{ site.baseurl }}/images/schools/2007.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
The 2007 winter school focused on Monte Carlo methods and their use across several scientific domains. The programme introduced fundamental Monte Carlo techniques and their role in simulating physical systems, followed by applications in data assimilation where stochastic sampling is used to combine models and observations. The school also highlighted how Monte Carlo‑based approaches are used in financial mathematics. A dedicated module on Markov Chain Monte Carlo (MCMC) provided deeper insight into algorithms for sampling complex probability distributions.
<div style="clear: both;"></div>

### [2006: Finite Element Method and Turbulent Flow Simulation](https://www.sintef.no/projectweb/evita/2006/)

<img src="{{ site.baseurl }}/images/schools/2006.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2005: Inverse Problems and Parameter Identification for PDE models](https://www.sintef.no/projectweb/evita/2005/)

<img src="{{ site.baseurl }}/images/schools/2005.webp" style="float: right; width: 25%; margin-left: 20px;">
...
### [2004: Adaptive Methods for PDEs with Emphasis on Evolutionary Equations](https://www.sintef.no/projectweb/evita/2004/)

<img src="{{ site.baseurl }}/images/schools/2004.jpg" style="float: right; width: 35%; margin-left: 20px;">
...
### [2003: Modern Numerical Methods for Nonlinear Partial Differential Equations and Level Set Technology](https://www.sintef.no/projectweb/evita/2003/)

<img src="{{ site.baseurl }}/images/schools/2003.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2002: Modern Computational Methods for Fluid Dynamics](https://www.sintef.no/projectweb/evita/2002/)

<img src="{{ site.baseurl }}/images/schools/2002.webp" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
...
### [2001: Parallel Computing with Emphasis on Clusters](https://www.sintef.no/projectweb/evita/2001/)

<img src="{{ site.baseurl }}/images/schools/2001.jpg" style="float: right; width: {{ page.image_width }}; margin-left: 20px;">
